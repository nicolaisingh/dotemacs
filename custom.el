(custom-set-variables
 ...
 '(package-selected-packages
   '(ztree nav-flash company-nixos-options nix-mode nixos-options dap-mode bui nov highlight-numbers lorem-ipsum command-log-mode imenu-list yasnippet package-lint currency-convert company-native-complete native-complete saveplace-pdf-view graphviz-dot-mode company-restclient restclient know-your-http-well multiple-cursors inf-clojure clojure-mode aggressive-indent tree-mode json-navigator prism find-file-in-repository dired-toggle diminish transpose-frame amx unfill readline-complete writeroom-mode magit htmlize discover-my-major lsp-mode flycheck flycheck-kotlin typing company edit-server js2-mode kotlin-mode smartparens json-mode origami browse-kill-ring which-key plantuml-mode centered-cursor-mode expand-region pdf-tools))
