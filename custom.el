(custom-set-variables
 ...
 '(package-selected-packages
   '(pass password-store password-store-otp avy highlight-indent-guides
          cape corfu saveplace-pdf-view pcsv gptel deadgrep cov pytest
          prodigy uuidgen blacken org-roam emms compat emacsql f
          git-commit log4e lsp-docker magit-section markdown-mode
          shell-maker transient treemacs visual-fill-column
          with-editor yaml focus elpy chess devdocs chatgpt-shell
          diff-hl org-alert edit-indirect consult-dir dired-recent
          selected calibre osm easy-kill org-present org-modern
          orderless alert chronos multi-term esh-help eshell-up
          eshell-z exec-path-from-shell slime ox-jira ox-gfm ox-slack
          git-timemachine consult marginalia flycheck-package csv-mode
