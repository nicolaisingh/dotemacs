(custom-set-variables
 ...
 '(package-selected-packages
   '(alert chronos multi-term esh-help eshell-up eshell-z
           ...
           magit htmlize discover-my-major flycheck flycheck-kotlin
           typing company edit-server js2-mode kotlin-mode smartparens
           json-mode origami browse-kill-ring which-key plantuml-mode
