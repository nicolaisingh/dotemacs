...
(custom-set-faces
 ...
 '(mode-line ((t (:background "gray40" :foreground "white" :box (:line-width 2 :color "gray40")))))
 '(mode-line-highlight ((t (:underline t))))
 '(mode-line-inactive ((t (:inherit mode-line :background "gray90" :foreground "gray45" :box (:line-width 2 :color "gray90") :weight light))))
