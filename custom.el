(custom-set-variables
 ...
 '(package-selected-packages
   '(pcsv gptel deadgrep cov pytest nnreddit prodigy uuidgen blacken
          org-roam emms compat emacsql f git-commit log4e lsp-docker
          magit-section markdown-mode shell-maker transient treemacs
