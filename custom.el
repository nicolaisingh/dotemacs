(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multiple-cursors inf-clojure clojure-mode aggressive-indent tree-mode json-navigator prism find-file-in-repository dired-toggle diminish transpose-frame amx ido-completing-read+ ox-odt unfill readline-complete writeroom-mode counsel-projectile projectile magit htmlize discover-my-major lsp-ui company-lsp lsp-mode flycheck flycheck-kotlin typing company-auctex company edit-server js2-mode kotlin-mode smartparens json-mode origami browse-kill-ring ace-window which-key counsel afternoon-theme plantuml-mode avy avy-zap ivy centered-cursor-mode change-inner expand-region modalka smex cyberpunk-theme ido-vertical-mode pdf-tools auctex)))
