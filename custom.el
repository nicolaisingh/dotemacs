(custom-set-variables
 ...
 '(package-selected-packages
   '(edit-indirect consult-dir dired-recent selected calibre emms osm
                   easy-kill org-present org-modern orderless
                   virtual-auto-fill org-roam alert chronos multi-term
                   esh-help eshell-up eshell-z exec-path-from-shell
                   slime ox-jira ox-gfm ox-slack git-timemachine
                   consult marginalia saveplace-pdf-view
                   flycheck-package csv-mode atomic-chrome
                   solidity-mode dockerfile-mode yaml-imenu yaml-mode
                   dash ag js2-refactor xref-js2 typescript-mode
                   company-go lsp-treemacs lsp-mode go-mode ztree
                   nav-flash company-nixos-options nix-mode
                   nixos-options dap-mode bui nov highlight-numbers
...
(custom-set-faces
 ...
 ;; '(default ((t (:font "Source Code Pro-10"))))
 '(default ((t (:font "DejaVu Sans Mono-9"))))
