...
(personal-theme--colors-let
  ...
  (let* (;; frame elements
    ...
    (custom-theme-set-faces
     ...
     `(mode-line ((t (:background ,bg-active :box ,box-active :overline t))))
     ...
     `(howm-reminder-deadline-face ((t (,@(funcall color-box-white-text color-red)))))
     `(howm-reminder-defer-face ((t (,@(funcall color-box-white-text color-magenta)))))
     `(howm-reminder-normal-face ((t (,@(funcall color-box-black-text color-cyan-light)))))
     ...
     `(howm-reminder-tomorrow-face ((t (:foreground "gray50" :inverse-video t))))
