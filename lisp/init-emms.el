...
(let ((map emms-playlist-mode-map))
  (keymap-set map "F" #'emms-show-all)
  (keymap-set map "z" #'emms-metaplaylist-mode-go)
  (keymap-set map "%" #'emms-shuffle)
  (keymap-set map "M" #'emms-mark-mode)
  (keymap-set map "," #'emms-seek-backward)
  (keymap-set map "." #'emms-seek-forward)
  (keymap-set map "C-x C-w" #'emms-my-playlist-write))

(let ((map emms-mark-mode-map))
  (keymap-set map "M" #'emms-mark-mode-disable))

(let ((map emms-browser-mode-map))
  (keymap-set map "R" #'emms-browser-replace-playlist)
  (keymap-set map "a" #'emms-add-directory-tree))

(let ((map emms-metaplaylist-mode-map))
  (keymap-set map "f" #'emms-my-metaplaylist-find-playlist)
  (keymap-set map "z" #'emms-playlist-mode-go)
  (keymap-set map "G" #'emms-my-metaplaylist-load-all-playlists))

(let ((map dired-mode-map))
  (keymap-set map "C-c M a" #'emms-add-dired)
  (keymap-set map "C-c M A" #'emms-play-dired))
