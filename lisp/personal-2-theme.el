...
(personal-theme--colors-let personal-theme--color-alist
  (let* ((fg-inactive color-gray-4)
    ...
    (custom-theme-set-faces
     ...
     ;; outline
     `(outline-1 ((t (:foreground ,color-black :background ,color-pale-gray :height 1.0))))
     `(outline-2 ((t (:foreground ,color-red-3 :background ,color-pale-red))))
     `(outline-3 ((t (:foreground ,color-green-3 :background ,color-pale-green))))
     `(outline-4 ((t (:foreground ,color-blue :background ,color-pale-blue))))
