...
(let ((map global-map))
  (keymap-set map "C-c n f" #'org-roam-node-find)
  (keymap-set map "C-c n c" #'org-roam-capture)
  (keymap-set map "C-c n g" #'org-roam-graph)
  (keymap-set map "C-c n %" #'org-roam-node-random)
  (keymap-set map "C-c n j" #'org-roam-dailies-capture-today)
  (keymap-set map "C-c n J" #'org-roam-dailies-capture-date)
  (keymap-set map "C-c n y" #'org-roam-dailies-goto-yesterday)
  (keymap-set map "C-c n ." #'org-roam-dailies-goto-next-note-repeatable)
  (keymap-set map "C-c n ," #'org-roam-dailies-goto-previous-note-repeatable))
