---
mode: subagent
description: A subagent specialized in creating comprehensive unit tests with 100% code coverage. Use this agent when the user needs help writing unit tests, integration tests, achieving full test coverage, setting up test frameworks, or implementing test-driven development (TDD). This agent focuses on creating tests that exercise all code paths, edge cases, and error conditions.
inherit: code
maxSteps: 30
tools:
  byDefault: ask
